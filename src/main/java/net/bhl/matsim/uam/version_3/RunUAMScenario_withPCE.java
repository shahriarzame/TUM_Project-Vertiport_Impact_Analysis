package net.bhl.matsim.uam.version_3;
 ...
 */
public class RunUAMScenario_withPCE {
	...
	public static Scenario setScenario(Scenario scenario) {
		return RunUAMScenario_withPCE.scenario = scenario;
	}
	...
	public static Controler createControler() {
		...
		config.qsim().setPcuThresholdForFlowCapacityEasing(0.16);
